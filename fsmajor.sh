...
bindkey -s '^[OR' 'play -n synth 0.1 sine A#4 > /dev/null 2>&1^J'
bindkey -s '^[OS' 'play -n synth 0.1 sine B4 > /dev/null 2>&1^J'
bindkey -s '^[[15~' 'play -n synth 0.1 sine C#5 > /dev/null 2>&1^J'
bindkey -s '^[[17~' 'play -n synth 0.1 sine D#5 > /dev/null 2>&1^J'
bindkey -s '^[[18~' 'play -n synth 0.1 sine E#5 > /dev/null 2>&1^J'
bindkey -s '^[[19~' 'source fsminor.sh > /dev/null 2>&1^J'
